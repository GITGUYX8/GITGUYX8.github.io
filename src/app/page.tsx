    ...
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="flex flex-col justify-center pt-8">
              ...
              <p className="text-[13px] sm:text-[14px] text-zinc-500 dark:text-zinc-400">Cloud · Backend · Robotics</p>
            </div>
          </div>
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-0 px-4 flex flex-col z-10 relative min-h-screen">
        <p className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4">
          Software Engineer. I build cloud-native platforms, backend systems, and robotics tooling.
        </p>

        <ul className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4 pl-4">
          <li className="flex gap-1.5"><span>•</span><span>Cloud & DevOps, distributed systems, and competitive programming excite me.</span></li>
          ...
          <li className="flex gap-1.5"><span>•</span><span>Currently building <span className="font-semibold text-zinc-900 dark:text-white">ROS 2 lab platforms on EKS</span> and <span className="font-semibold text-zinc-900 dark:text-white">multi-agent work-order pipelines</span>.</span></li>
        </ul>

        {/* Buttons */}
        <div className="flex flex-wrap items-center gap-2 mt-4">
          <FlipCoverButton href="mailto:signinwithyash1178@gmail.com" label="Book an intro call" />
          <Link href="/contact">
            <SoftPillButton
              as="span"
              variant="secondary"
        ...
        <div id="contact" className="mt-6 scroll-mt-24">
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              { name: 'GitHub', href: 'https://github.com/GITGUYX8', icon: <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" stroke="currentColor" strokeWidth="2" fill="none"></path> },
              { name: 'LinkedIn', href: 'https://linkedin.com/in/yashvardhan-singh-6026b731b', icon: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zM4 2a2 2 0 1 1-2 2 2 2 0 0 1 2-2z" stroke="currentColor" strokeWidth="2" fill="none"></path> },
              { name: 'X', href: 'https://x.com/', icon: <path d="M4 4l11.733 16h4.267l-11.733 -16zM4 20l6.768 -6.768M20 4l-6.768 6.768" stroke="currentColor" strokeWidth="2" fill="none" /> },
              { name: 'LeetCode', href: 'https://leetcode.com/u/_yASHy_/', icon: <path d="M16 18l6-6-6-6M8 6l-6 6 6 6" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" /> },
              { name: 'Codeforces', href: 'https://codeforces.com/profile/_Yashy_', icon: <path d="M4 20V10M10 20V4M16 20v-7M22 20H2" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" /> },
            ].map((social, i) => (
        ...
        {/* Achievements */}
        <div id="achievements" className="mt-6 flex flex-col relative scroll-mt-24">
          {/* Top full-width line */}
          <div
            className="absolute top-0 left-[-100vw] right-[-100vw] h-0 border-t border-black/30 dark:border-white/[0.15] pointer-events-none"
            style={{
          ...
          <div className="py-4 px-4 -mx-4 flex justify-center relative hover:bg-zinc-50 dark:hover:bg-zinc-900/20 transition-colors cursor-pointer rounded-b-lg mt-0">
            ...
            <Link href="https://codeforces.com/profile/_Yashy_" target="_blank" rel="noopener noreferrer" className="relative group block mt-0">
              <div className="absolute -inset-[5px] border border-black/5 dark:border-white/5 rounded-[11px] pointer-events-none transition-colors duration-300 group-hover:border-black/10 dark:group-hover:border-white/10" />
              <div className="relative flex items-center gap-1.5 px-4 py-2 bg-zinc-50 hover:bg-zinc-100 dark:bg-[#09090b] dark:hover:bg-[#121214] text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 rounded-[6px] text-[13px] font-medium transition-all duration-300 border border-black/5 dark:border-white/5 shadow-sm shadow-black/20 dark:shadow-lg dark:shadow-black/80">
                View All
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-zinc-500 group-hover:text-zinc-900 dark:group-hover:text-zinc-300 transition-colors" fill="none" stroke="currentColor" strokeWidth="2.5">
