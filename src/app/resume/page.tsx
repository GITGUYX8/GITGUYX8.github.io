...
const resumePath = "/Yashvardhan_Singh_Resume_v2.pdf";

export const metadata: Metadata = {
  title: "Resume | Yashvardhan Singh",
  description: "Resume of Yashvardhan Singh, software engineer.",
};
      ...
      <section className="relative z-10 ml-0 mr-0 flex min-h-screen flex-col px-4 pb-12 pt-[calc(22vh+112px)] md:ml-[30%] md:mr-[30%]">
        <div className="flex flex-wrap items-center justify-between gap-3 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href={resumePath}
              download="Yashvardhan_Singh_Resume_v2.pdf"
        ...
        <div className="relative aspect-[8.5/11] w-full overflow-hidden rounded-[6px] border border-black/10 bg-white shadow-sm dark:border-white/10">
          ...
          >
            <p className="p-6 text-[13px] text-zinc-500">
              Your browser cannot preview PDFs.{" "}
              <a href={resumePath} className="underline" download>
                Download the resume
              </a>
              .
            </p>
