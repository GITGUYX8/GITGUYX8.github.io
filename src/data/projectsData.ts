...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    github: "https://github.com/GITGUYX8/BM_TASK",
    live: "",
  ...
  },
  {
    slug: "tts-locally",
    title: "TTS Locally",
    imageTitle: "TUI Main Menu",
    src: "/project-image/tts-locally.png",
    video: "",
    description: "Offline clipboard-to-speech utility for Linux built on Piper voices. Toggle speech from the clipboard with a keyboard shortcut, with sentence chunking and queued playback for faster first audio, persistent model loading, and a terminal UI for voice management.",
    tech: ["python", { label: "Piper TTS" }, { label: "Bash" }, { label: "Linux" }, { label: "TUI" }],
    github: "https://github.com/GITGUYX8/TTS-Locally",
    live: "",
    backgroundImage: "/project-image/tts-locally.png",
    hasPin: false,
    status: "live",
  },
];
