 ...
 * revealing the email button inside linking to the contact email.
 */
export function FlipCoverButton({
  href = "mailto:signinwithyash1178@gmail.com",
  ...
  return (
    <section className={`${styles.section} ${className}`}>
      ...
      {/* Inside: Revealed small email button */}
